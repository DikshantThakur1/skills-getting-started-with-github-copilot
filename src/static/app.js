      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsMarkup = details.participants.length
          ? details.participants
              .map(
                (email) =>
                  `<li class="participants-item"><span>${email}</span><button class="participant-remove-button" data-activity="${name}" data-email="${email}" title="Remove participant">×</button></li>`
              )
              .join("")
          : '<li class="participants-item empty">No participants yet</li>';
